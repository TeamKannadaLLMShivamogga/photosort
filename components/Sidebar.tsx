...
import { 
  ...
  Users, LogOut, Calendar, Camera, Info, CreditCard
} from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ onNavigate, currentView }) => {
  ...
  const getNavItems = () => {
    if (currentUser?.role === UserRole.USER) {
      ...
      // Super Admin - Sidebar active links
      return [
  ...
  return (
    <aside className="w-60 bg-[#111827] flex flex-col h-screen fixed left-0 top-0 z-30 border-r border-gray-800">
